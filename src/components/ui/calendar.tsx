  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-slate-900 text-slate-200 hover:bg-slate-900 hover:text-slate-50 focus:bg-slate-900 focus:text-slate-50 dark:bg-slate-900 dark:text-slate-200 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-900 dark:focus:text-slate-900",
        day_today:
